                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text"  class="form-control-plaintext"
                                               id="txtNominaCurso" value="00001606">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="txtNombrePersonaCurso">Nombre</label>
                                        <input type="text" readonly="" class="form-control-plaintext"
                                               id="txtNombrePersonaCurso" value="HADBET AYARI ALTAMIRANO MARTINEZ">
                                    </div>
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3" id="divShiftleader" style="display: none">
                                        ...
                                        <select class="custom-select" id="cbShiftleader"
                                                onchange="cargarCursosSelect()">
                                            <option selected>Abrir menu</option>
                                        </select>
                                    </div>
                                    <div class="form-group mb-3" id="divEncargado" style="display: none">
                                        <label for="cbEncargado">Encargado</label>
                                        <select class="custom-select" id="cbEncargado" onchange="cargarCursosSelect()">
                                            <option selected>Abrir menu</option>
                                        </select>
                                    </div>
                                </div> <!-- /.col -->
                                <div class="col-md-6" id="divCurso" style="display: none">
                                    <div class="form-group mb-3">
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <br>
                                        <br>
                                        <button type="button" onclick="cargarSeleccionCursos()" id="btnEliminarCurso"
                                                class="btn mb-2 btn-success float-right text-white">Agregar<span
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <br>
                                        <label for="cbHorario">Cursos seleccionados</label>
                                        <select id="cbHorario" multiple="" class="form-control">
                                        </select>
                                        <br>
                                        <button type="button" onclick="eliminarCurso()"
                                                class="btn mb-2 btn-danger float-right text-white">Borrar<span
                                                class="fe fe-chevron-right fe-16 ml-2"></span></button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <h5 class="card-title">Mis Cursos por asistir</h5>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <h5 class="card-title">Mis Cursos asistidos</h5>
                            <table id="tablaCursosAsistidos" class="table table-hover">
                                <thead>
                                <tr>
                                    <th>Nombre Curso</th>
                                    <th>Fecha</th>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <h5 class="card-title">Mis Cursos por calificar</h5>
                            <table id="tablaConcluidos" class="table table-hover">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre Curso</th>
        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <h5 class="card-title">Mis Certificados</h5>
                            <table id="tablaCertificados" class="table table-hover">
                                <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>Nombre Curso</th>
